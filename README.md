...
- **系统提示词**: 自定义AI行为指导，支持多行文本输入
- **快速模板**: 提供6个预设专业模板，一键应用系统提示词
- **本地存储**: 密钥、参数和系统提示词安全保存在浏览器本地
- **参数说明**: 提供详细的参数说明和推荐值
- **表单验证**: 输入范围验证和错误提示
- **主题适配**: 完美支持亮色和暗色主题
...
- **系统提示词集成**: 自动将用户设置的系统提示词添加到API请求中
